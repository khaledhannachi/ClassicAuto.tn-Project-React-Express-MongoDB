      ...
      <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
        ...
        <div class="flex mt-8 flex-col md:flex-row md:justify-between">
          <p class="w-full md:w-2/3 text-gray-400">
            Whether you are looking at buying your dream car or selling a
            classic or vintage car, ClassicAuto.tn has thousands of premium
            classics for sale on our online website. Muscle cars, exotics, and
            late-model classics are available from private sellers, specialty
            dealers, and collector cars in Tunisia.
          </p>
          <div class="w-44 pt-6 md:pt-0">
          <Link to={`/contact`}><a class="bg-red-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">
              Contact US
            </a></Link>
          </div>
        </div>
