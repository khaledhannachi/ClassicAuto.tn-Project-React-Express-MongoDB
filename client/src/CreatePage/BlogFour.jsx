      ...
      <main>
        <article>
          <header class="mx-auto mt-20 max-w-screen-lg rounded-t-lg bg-white pt-16 text-center shadow-lg">
            <p class="text-gray-500">Published January 14, 2024</p>
            <h1 class="mt-2 text-4xl font-bold text-gray-900 sm:text-5xl">
              Why Do People Still Love Classic Cars?
            </h1>
            <p class="mt-6 text-lg text-gray-700">By Ian Davies</p>
          ...
          <div class="mx-auto max-w-screen-lg space-y-12 rounded-b-lg bg-white px-8 pt-10 pb-20 font-serif text-lg tracking-wide text-gray-700 sm:shadow-lg">
            ...
            <p>
              ...
              Basically, they’re better in just about every way. Yet despite
              this, the clearly inferior classic car not only still exists, but
              is positively thriving these days. Why?
            </p>
            <p>
              There is no simple answer to this, but instead a combination of
              factors that each play a part. First, there’s the design of the
              car itself. Classic cars were created very much in an analogue
              world where designers used pencil and paper to create elegant
              shapes and flowing lines that would just not be possible on the
              computer-based design software used by modern car designers. Take
              the front wing of a Jaguar XK120 or the profile of a Ferrari 250
              GTO, for example.
            </p>

            <img
              src="https://d2dsc1gf0t80gb.cloudfront.net/wp-content/uploads/2015/06/20193615/why-do-people-still-love-classic-cars-1476934609341.jpg"
              alt="..."
            />

            <p>
              These designs are beautiful in every way, but are shapes that no
              modern designer would create nowadays—often, the way the metal
              frame underneath the bodywork used during the prototype stage (and
              even “bucks” used to shape bodywork) would have a direct influence
              on the car’s form. These designs belong to a previous age—an age
              that many people fondly look back on, where designers were
              unencumbered by constraints such as crash tests, or aerodynamic
              drag coefficients, and instead created shapes that reflected the
              mood and trends of the time. Modern production techniques have
              also removed much of the character from new cars. Mass production
              “systems” complete with soulless computers and robots on the
              production lines producing identical parts 24 hours a day, 7 days
              a week, are focussed on one thing: meeting the targets and quotas
              set by the car manufacturers to maximise efficiency and
              shareholder profit.
            </p>
            <p>
              Classic car production, on the other hand, was largely a manual
              process performed by craftsmen using simple tools complemented by
              decades of experience to create panels by hand and by eye. The
              results of this are creations that have withstood the hardships of
              daily usage and weathered the passage of time. Not all are like
              this, of course. Some were very poorly designed, and built with
              even less care, but this is what separates classic cars from cars
              that are merely old.
            </p>
            ...
            <p>
              Driving a classic car requires a great deal of manual input from
              the driver, from adjusting the fuel/air mixture manually with the
              choke, to selecting gears and controlling the engagement of power
              to the wheels with the clutch. All this needs to be done in a way
              that gets the best out of the engine and transmission—but proper
              technique also protects the longevity of the ageing components.
              Getting all this right is inherently more challenging than the
              modern equivalent of electronic ignition, automatic transmissions
              and electronic driver aids, but a far more rewarding and
              satisfying experience. Classic car owners mostly don’t embark upon
              a journey to reach a destination, but instead the journey is the
              destination.
            </p>
            <img
              src="https://d2dsc1gf0t80gb.cloudfront.net/wp-content/uploads/2015/06/20193549/why-do-people-still-love-classic-cars-1476934609430.jpg"
              alt="..."
            />
          </div>
        </article>
